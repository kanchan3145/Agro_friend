      ...
      <div className="pt-24 mx-auto w-full max-w-screen-xl px-6 lg:px-20">
        <section className="py-4 lg:py-12">
          <div className="grid items-start gap-6 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="flex items-center min-h-screen">
              <div className="container mx-auto">
                <div className="max-w-md mx-auto p-5 rounded-md ring-1 ring-emerald-500 shadow-2xl text-center">
                  <h1 className="my-3 text-3xl font-semibold">Contact Us</h1>
                  ...
                  {/* Google Form Link */}
                  <a
                    href="https://docs.google.com/forms/d/e/1FAIpQLSei6vfsqcvy7PLIlcstpdza14Q93oIppWoyB-HFuvyA--kfmw/viewform?usp=header"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block w-full px-4 py-3 font-semibold text-white bg-emerald-500 rounded-md hover:bg-white hover:text-black hover:border hover:border-emerald-500 transition duration-300"
                  >
                    Open Google Form
                  </a>
                </div>
